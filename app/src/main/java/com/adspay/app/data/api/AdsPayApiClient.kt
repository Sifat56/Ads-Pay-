    ...
    fun fetchSettings(): Result<AppSettings> {
        return try {
            ...
            val settings = AppSettings(
                ...
                pointMonetaryValue = obj.optDouble("pointMonetaryValue", 2.0),
                currencySymbol = obj.optString("currencySymbol", "৳"),
                referralCommissionPercent = obj.optDouble("referralCommissionPercent", 10.0),
                minWithdrawalPoints = obj.optDouble("minWithdrawalPoints", 100.0),
                maxWithdrawalPoints = obj.optDouble("maxWithdrawalPoints", 5000.0),
                ...
                isQuizEnabled = obj.optBoolean("isQuizEnabled", true),
